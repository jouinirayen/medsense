...
<head>
    ...
    <!-- CSS Files -->
    <!-- CSS Files -->
    <link rel="stylesheet" href="../page-accueil/css/style.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="../../backoffice/dashboard_medecin/css/appointments.css?v=<?php echo time(); ?>">
    ...
    <link rel="stylesheet" href="../page-accueil/css/chat.css?v=<?php echo time(); ?>">
...
<body>
    <!-- Header -->
    <?php
    $activePage = 'rendezvous';
    include '../page-accueil/partials/header.php';
    ?>
    ...
    <main class="main-container">
        ...
        <?php if (empty($appointments)): ?>
            <div class="empty-state">
                ...
                <a href="../page-accueil/front.php" class="btn-primary">Prendre un rendez-vous</a>
            </div>
        <?php else: ?>
                    ...
                    <div class="appointment-card">
                        ...
                        <?php if ($appt['statut'] === 'confirme'): ?>
                            <div
                                ...
                                // URL must match where scan_handler.php is located
                                $qrUrl = "http://172.20.10.3/projet_unifie/views/backoffice/dashboard_medecin/scan_handler.php?id=" . $appt['idRDV'] . "&token=" . $qrToken;
                                ?>
        ...
        function openRatingModal(appointmentId) {
            Swal.fire({
                ...
                html: `
                    ...
                    <textarea id="rating-comment" placeholder="Racontez votre expérience (optionnel)..." style="width: 80%; margin-top: 10px; padding: 10px; border: 1px solid #cbd5e1; border-radius: 8px; font-family: inherit; resize: vertical;" rows="3"></textarea>
                    <p style="color: #64748b; font-size: 0.9rem; margin-top: 10px;">Cliquez sur les étoiles pour noter</p>
                `,
                showCancelButton: true,
                ...
                preConfirm: () => {
                    ...
                    const comment = Swal.getPopup().querySelector('#rating-comment').value;
                ...
                if (result.isConfirmed) {
                    ...
                    inputRating.type = 'hidden'; inputRating.name = 'rating'; inputRating.value = result.value.rating;

                    const inputComment = document.createElement('input');
                    inputComment.type = 'hidden'; inputComment.name = 'comment'; inputComment.value = result.value.comment;
    ...
    <?php include '../page-accueil/partials/chat_widget.php'; ?>
    <script src="../page-accueil/js/chat.js?v=<?php echo time(); ?>"></script>
</body>
