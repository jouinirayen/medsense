    ...
    <main class="profile-container">
        ...
        if (!empty($patientReviews)):
            ...
            <div class="reviews-marquee-container">
                <h3
                    style="margin: 0 0 1.5rem 0.5rem; font-size: 1.4rem; color: #0f172a; font-weight: 700; display:flex; align-items:center; gap:10px;">
                        ...
                        <div class="review-card-mini">
                            ...
                            <div class="review-mini-header">
                                ...
                                <div class="review-info">
                                    <span
                                        class="review-author"><?= htmlspecialchars($rev['prenom'] . ' ' . $rev['nom']) ?></span>
            ...
            if (status === 'success') {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '/projet_unifie/views/frontoffice/page-rendezvous/afficher_rendezvous_patient.php';
                    }
                });
