<?php
/**
 * Page de visualisation détaillée d'une réclamation
 */
...
<div class="card">
    ...
    <div class="card-meta">
        ...
        <p><strong>ID :</strong> <?php echo htmlspecialchars($reclamation['id']); ?></p>
    </div>

    <div class="card-actions">
        <a href="modifier_reclamation.php?id=<?php echo $reclamation['id']; ?>" 
           class="btn btn-warning">Modifier</a>
        <a href="mes_reclamations.php" class="btn">Retour</a>
    </div>
</div>
...
<?php else: ?>
    <?php foreach ($reponses as $reponse): ?>
        <div class="card">
            <p><strong><?php echo htmlspecialchars($reponse['username'] ?? 'Admin'); ?></strong></p>
