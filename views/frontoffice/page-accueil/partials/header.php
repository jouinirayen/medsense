...
<body>
    <header class="header">
        ...
        <nav class="nav-links">
            <a href="<?php echo isset($navPaths) ? $navPaths['accueil'] : '/projet2025/views/frontoffice/page-accueil/front.php'; ?>"
                class="nav-link <?php echo (!isset($activePage) || $activePage === 'accueil') ? 'active' : ''; ?>">
                <span class="nav-icon"><i class="fas fa-home"></i></span>
                <span>Accueil</span>
            </a>

            <a href="<?php echo isset($navPaths) ? $navPaths['rendezvous'] : '/projet2025/views/frontoffice/page-rendezvous/afficher_rendezvous_patient.php'; ?>"
                class="nav-link <?php echo (isset($activePage) && $activePage === 'rendezvous') ? 'active' : ''; ?>">
                <span class="nav-icon"><i class="fas fa-calendar-check"></i></span>
                <span>Mes Rendez-vous</span>
            </a>

            <a href="<?php echo isset($navPaths) ? $navPaths['blog'] : '/projet2025/views/frontoffice/page-blog/blog.php'; ?>"
                class="nav-link <?php echo (isset($activePage) && $activePage === 'blog') ? 'active' : ''; ?>">
                <span class="nav-icon"><i class="fas fa-blog"></i></span>
                <span>Blog</span>
            </a>

            <a href="<?php echo isset($navPaths) ? $navPaths['reclamation'] : '/projet2025/views/frontoffice/page-reclamation/reclamation.php'; ?>"
            ...
            <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                <a href="<?php echo isset($navPaths) ? $navPaths['admin'] : '/projet2025/views/backoffice/dashboard_service/dashboard.php'; ?>"
                    class="nav-link">
            ...
            <a href="<?php echo isset($navPaths) ? $navPaths['logout'] : '../../logout.php'; ?>" class="nav-link">
