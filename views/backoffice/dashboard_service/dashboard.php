...
<body>
    <header class="header">
        ...
        <nav class="nav-links">
            <a href="../admin_hub.php" class="nav-link">
                <span class="nav-icon"><i class="fas fa-th-large"></i></span>
                <span>Hub Central</span>
            </a>
            <a href="../../backoffice/admin-users.php" class="nav-link">
            ...
            <a href="../../back-office/dashboard.php" class="nav-link">
                <span class="nav-icon"><i class="fas fa-newspaper"></i></span>
                <span>Blog</span>
            </a>
            <a href="../../backoffice/reponse/admin_reclamations.php" class="nav-link">
