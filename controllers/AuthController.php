...
class AuthController
{
    ...
    private function startUserSession(Utilisateur $user): void
    {
        ...
        // Variables natives projet_unifie
        $_SESSION['user_nom'] = $user->getNom();
        $_SESSION['user_prenom'] = $user->getPrenom();
        $_SESSION['user_email'] = $user->getEmail();
        $_SESSION['user_role'] = $user->getRole();

        // Variables unifiées pour compatibilité globale (projet_unifie, Urgence, Medsense)
        $_SESSION['nom'] = $user->getNom();
        $_SESSION['prenom'] = $user->getPrenom();
        $_SESSION['email'] = $user->getEmail();
        $_SESSION['role'] = $user->getRole();
        $_SESSION['user_name'] = $user->getPrenom() . ' ' . $user->getNom();
        $_SESSION['photo_url'] = $user->getPhotoProfilUrl();

        $_SESSION['login_time'] = time();

        error_log("DEBUG - Session démarrée et unifiée pour: " . $user->getEmail());
    }
